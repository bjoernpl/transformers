...
_import_structure = {
    "configuration_llama": ["BITLLAMA_PRETRAINED_CONFIG_ARCHIVE_MAP", "LlamaConfig"],
}
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .modeling_bitllama import BitLlamaForCausalLM, LlamaForSequenceClassification, BitLlamaModel, BitLlamaPreTrainedModel
